...
/**
 * The ActorDefinition resource is used to describe an actor - a human or an application that plays
 * a role in data exchange, and that may have obligations associated with the role the actor plays.
 */
@Serializable(with = ActorDefinitionSerializer::class)
...
public data class ActorDefinition(
   ...
   * actor definition is (or will be) published. This URL can be the target of a canonical
   * reference. It SHALL remain the same when the actor definition is stored on different servers.
   *
   ...
   * the actor definition author and is not expected to be globally unique. For example, it might be
   * a timestamp (e.g. yyyymmdd) if a managed version is not available. There is also no expectation
   * that versions can be placed in a lexicographical sequence.
   *
   * There may be different actor definition instances that have the same identifier but different
   ...
   * changes. In addition, it should change when the substantive content of the actor definition
   * changes.
   *
   * The date is often not tracked until the resource is published, but may be present on draft
   * content. Note that this is not the same as the resource last-modified-date, since the resource
   * may be a secondary representation of the actor definition. Additional specific dates may be
   ...
   *
   * Usually an organization but may be an individual. The publisher (or steward) of the actor
   * definition is the organization or individual primarily responsible for the maintenance and
   * upkeep of the actor definition. This is not necessarily the same individual or organization
   ...
   * for appropriate actor definition instances.
   *
   ...
   *
   * It may be possible for the actor definition to be used in jurisdictions other than those for
   ...
   *
   * This element does not describe the usage of the actor definition. Instead, it provides
  ...
  public class Builder(
     ...
     * of this actor definition is (or will be) published. This URL can be the target of a canonical
     * reference. It SHALL remain the same when the actor definition is stored on different servers.
     *
     ...
     * by the actor definition author and is not expected to be globally unique. For example, it
     ...
     * resource may be a secondary representation of the actor definition. Additional specific dates
     ...
     * maintenance of the actor definition.
     *
     * Usually an organization but may be an individual. The publisher (or steward) of the actor
     * definition is the organization or individual primarily responsible for the maintenance and
     * upkeep of the actor definition. This is not necessarily the same individual or organization
     * that developed and initially authored the content. The publisher is the primary point of
     * contact for questions or issues with the actor definition. This item SHOULD be populated
     ...
     * searching for appropriate actor definition instances.
     *
     * When multiple useContexts are specified, there is no expectation that all or any of the
     * contexts apply.
     */
    ...
    /**
     * A copyright statement relating to the actor definition and/or its contents. Copyright
     * statements are generally legal restrictions on the use and publishing of the actor
     * definition.
     *
     * ...
     */
    ...
    /** The capability statement for the actor (if the concept is applicable). */
    public var capabilities: Canonical.Builder? = null
    ...
    override fun build(): ActorDefinition =
      ActorDefinition(
        id = id,
        meta = meta?.build(),
