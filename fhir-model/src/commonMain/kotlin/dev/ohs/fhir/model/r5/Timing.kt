...
public data class Timing(
...
) : BackboneType(), FhirChoiceParticipants.TimingChoices {
  ...
  public data class Repeat(
    ...
    public class Builder() {
      ...
      /**
       * The units of time for the duration, in UCUM units Normal practice is to use the 'mo' code
       * as a calendar month when calculating the next occurrence.
       */
       ...
       * filtered by dayofWeek) on the specified times. If there's a timeOfDay, there cannot be a
       * when, or vice versa.
       */
