...
public data class MedicinalProductDefinition(
   ...
   */
  public val comprisedOf: List<Reference> = listOf(),
  /**
  ...
  public data class Name(
    ...
    public class Builder(
      ...
      /** Coding words or phrases of the name. */
      public var part: MutableList<Part.Builder> = mutableListOf()
  ...
  public class Builder(
     ...
     * a requirement to conduct post-authorization studies.
     */
     ...
     * recorded (see also PackagedProductDefinition.package.containedItem.item).
     */
    public var comprisedOf: MutableList<Reference.Builder> = mutableListOf()
