...
public data class Coverage(
  ...
  override fun toBuilder(): Builder =
    with(this) {
      Builder(status, kind, beneficiary.toBuilder()).apply {
        id = this@with.id
  ...
  public class Builder(
     ...
     * concatenation of the Coverage.SubscriberID and the Coverage.dependant. Note that not all
     * insurers issue unique member IDs therefore searches may result in multiple responses.
     */
     ...
     * Link to the paying party and optionally what specifically they will be responsible to pay.
     */
    public var paymentBy: MutableList<PaymentBy.Builder> = mutableListOf()
     ...
     *
     * May be self or a parent in the case of dependants. A subscriber is only required on certain
     * types of policies not all policies and that it is appropriate to have just a policyholder and
     * a beneficiary when not other party can join that policy instance.
     */
    public var subscriber: Reference.Builder? = null

    /** The insurer assigned ID for the Subscriber. */
    public var subscriberId: MutableList<Identifier.Builder> = mutableListOf()
     ...
     * etc. as the specific positioning of coverages depends upon the episode of care. For example;
     * a patient might have (0) auto insurance (1) their own health insurance and (2) spouse's
     * health insurance. When claiming for treatments which were not the result of an auto accident
     * then only coverages (1) and (2) above would be applicatble and would apply in the order
    ...
    /** The insurance plan details, benefits and costs, which constitute this insurance coverage. */
    public var insurancePlan: Reference.Builder? = null
