...
import dev.ohs.fhir.model.r4b.serializers.UriSerializer
import kotlin.Any
...
public open class Uri(
...
) : Element(id, extension), FhirChoiceParticipants.UriChoices, UriLike {
  ...
  public open class Builder() {
    ...
    public open fun build(): Uri =
      Uri(id = id, extension = extension.map { it.build() }, `value` = `value`)
  }
