...
import dev.ohs.fhir.model.r5.serializers.CodingSerializer
...
public data class Coding(
   ...
   * defined special URIs or it should be an absolute reference to some definition that establishes
...
) : DataType(), FhirChoiceParticipants.CodingChoices {
  ...
  public open class Builder() {
     ...
     * The URI may be an OID (urn:oid:...) or a UUID (urn:uuid:...). OIDs and UUIDs SHALL be
     * references to the HL7 OID registry. Otherwise, the URI should come from HL7's list of FHIR
     * defined special URIs or it should be an absolute reference to some definition that
     * establishes the system clearly and unambiguously.
     */
