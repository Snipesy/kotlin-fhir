...
internal object ExtensionSerializer : KSerializer<Extension> {
  ...
  private fun serializeInternal(encoder: CompositeEncoder, `value`: Extension) {
    ...
    when (val choice = value.`value`) {
      ...
      is Integer64 -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 23, it) }
        (choice.toElement())?.let {
      ...
      is PositiveInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 29, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 30, Hoisted.valueBase64BinarySer, it)
        }
      }
      is R5String -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 31, it) }
        (choice.toElement())?.let {
      ...
      is UnsignedInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 35, it) }
        (choice.toElement())?.let {
      ...
      is Address -> {
        encoder.encodeSerializableElement(descriptor, 43, Hoisted.valueAddressSer, choice)
      }
      is Age -> {
        encoder.encodeSerializableElement(descriptor, 44, Hoisted.valueAgeSer, choice)
      }
      is Annotation -> {
        encoder.encodeSerializableElement(descriptor, 45, Hoisted.valueAnnotationSer, choice)
      }
      is Attachment -> {
        encoder.encodeSerializableElement(descriptor, 46, Hoisted.valueAttachmentSer, choice)
      }
      is CodeableConcept -> {
        encoder.encodeSerializableElement(descriptor, 47, Hoisted.valueCodeableConceptSer, choice)
      }
      is CodeableReference -> {
        encoder.encodeSerializableElement(descriptor, 48, Hoisted.valueCodeableReferenceSer, choice)
      }
      is Coding -> {
        encoder.encodeSerializableElement(descriptor, 49, Hoisted.valueCodingSer, choice)
      }
      is ContactPoint -> {
        encoder.encodeSerializableElement(descriptor, 50, Hoisted.valueContactPointSer, choice)
      }
      is Count -> {
        encoder.encodeSerializableElement(descriptor, 51, Hoisted.valueCountSer, choice)
      }
      is Distance -> {
        encoder.encodeSerializableElement(descriptor, 52, Hoisted.valueDistanceSer, choice)
      }
      is Duration -> {
        encoder.encodeSerializableElement(descriptor, 53, Hoisted.valueDurationSer, choice)
      }
      is HumanName -> {
        encoder.encodeSerializableElement(descriptor, 54, Hoisted.valueHumanNameSer, choice)
      }
      is Identifier -> {
        encoder.encodeSerializableElement(descriptor, 55, Hoisted.valueIdentifierSer, choice)
      }
      is Money -> {
        encoder.encodeSerializableElement(descriptor, 56, Hoisted.valueMoneySer, choice)
      }
      is Period -> {
        encoder.encodeSerializableElement(descriptor, 57, Hoisted.valuePeriodSer, choice)
      }
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 58, Hoisted.valueQuantitySer, choice)
      }
      is Range -> {
        encoder.encodeSerializableElement(descriptor, 59, Hoisted.valueRangeSer, choice)
      }
      is Ratio -> {
        encoder.encodeSerializableElement(descriptor, 60, Hoisted.valueRatioSer, choice)
      }
      is RatioRange -> {
        encoder.encodeSerializableElement(descriptor, 61, Hoisted.valueRatioRangeSer, choice)
      }
      is Reference -> {
        encoder.encodeSerializableElement(descriptor, 62, Hoisted.valueReferenceSer, choice)
      }
      is SampledData -> {
        encoder.encodeSerializableElement(descriptor, 63, Hoisted.valueSampledDataSer, choice)
      }
      is Signature -> {
        encoder.encodeSerializableElement(descriptor, 64, Hoisted.valueSignatureSer, choice)
      }
      is Timing -> {
        encoder.encodeSerializableElement(descriptor, 65, Hoisted.valueTimingSer, choice)
      }
      is ContactDetail -> {
        encoder.encodeSerializableElement(descriptor, 66, Hoisted.valueContactDetailSer, choice)
      }
      is DataRequirement -> {
      ...
      is Availability -> {
        encoder.encodeSerializableElement(descriptor, 73, Hoisted.valueAvailabilitySer, choice)
      }
      ...
      is Dosage -> {
        encoder.encodeSerializableElement(descriptor, 75, Hoisted.valueDosageSer, choice)
      }
      is Meta -> {
        encoder.encodeSerializableElement(descriptor, 76, Hoisted.valueMetaSer, choice)
      }
    }
  }
