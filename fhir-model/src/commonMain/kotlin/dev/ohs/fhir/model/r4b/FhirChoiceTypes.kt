...
import dev.ohs.fhir.model.r4b.Address as AddressFhir
import dev.ohs.fhir.model.r4b.Age as AgeFhir
import dev.ohs.fhir.model.r4b.Annotation as AnnotationFhir
import dev.ohs.fhir.model.r4b.Attachment as AttachmentFhir
import dev.ohs.fhir.model.r4b.Base64Binary as Base64BinaryFhir
import dev.ohs.fhir.model.r4b.Boolean as BooleanFhir
import dev.ohs.fhir.model.r4b.Canonical as CanonicalFhir
import dev.ohs.fhir.model.r4b.CodeableConcept as CodeableConceptFhir
import dev.ohs.fhir.model.r4b.CodeableReference as CodeableReferenceFhir
import dev.ohs.fhir.model.r4b.Coding as CodingFhir
import dev.ohs.fhir.model.r4b.ContactDetail as ContactDetailFhir
import dev.ohs.fhir.model.r4b.ContactPoint as ContactPointFhir
import dev.ohs.fhir.model.r4b.Contributor as ContributorFhir
import dev.ohs.fhir.model.r4b.DataRequirement as DataRequirementFhir
import dev.ohs.fhir.model.r4b.Date as DateFhir
import dev.ohs.fhir.model.r4b.DateTime as DateTimeFhir
import dev.ohs.fhir.model.r4b.Decimal as DecimalFhir
import dev.ohs.fhir.model.r4b.Dosage as DosageFhir
import dev.ohs.fhir.model.r4b.Duration as DurationFhir
import dev.ohs.fhir.model.r4b.Expression as ExpressionFhir
import dev.ohs.fhir.model.r4b.HumanName as HumanNameFhir
import dev.ohs.fhir.model.r4b.Identifier as IdentifierFhir
import dev.ohs.fhir.model.r4b.Instant as InstantFhir
import dev.ohs.fhir.model.r4b.Integer as IntegerFhir
import dev.ohs.fhir.model.r4b.Markdown as MarkdownFhir
import dev.ohs.fhir.model.r4b.Meta as MetaFhir
import dev.ohs.fhir.model.r4b.Money as MoneyFhir
import dev.ohs.fhir.model.r4b.ParameterDefinition as ParameterDefinitionFhir
import dev.ohs.fhir.model.r4b.Period as PeriodFhir
import dev.ohs.fhir.model.r4b.PositiveInt as PositiveIntFhir
import dev.ohs.fhir.model.r4b.Quantity as QuantityFhir
import dev.ohs.fhir.model.r4b.Range as RangeFhir
import dev.ohs.fhir.model.r4b.Ratio as RatioFhir
import dev.ohs.fhir.model.r4b.RatioRange as RatioRangeFhir
import dev.ohs.fhir.model.r4b.Reference as ReferenceFhir
import dev.ohs.fhir.model.r4b.RelatedArtifact as RelatedArtifactFhir
import dev.ohs.fhir.model.r4b.SampledData as SampledDataFhir
import dev.ohs.fhir.model.r4b.Signature as SignatureFhir
import dev.ohs.fhir.model.r4b.String as StringFhir
import dev.ohs.fhir.model.r4b.Time as TimeFhir
import dev.ohs.fhir.model.r4b.Timing as TimingFhir
import dev.ohs.fhir.model.r4b.TriggerDefinition as TriggerDefinitionFhir
import dev.ohs.fhir.model.r4b.UnsignedInt as UnsignedIntFhir
import dev.ohs.fhir.model.r4b.Uri as UriFhir
import dev.ohs.fhir.model.r4b.Url as UrlFhir
import dev.ohs.fhir.model.r4b.UsageContext as UsageContextFhir
...
public object FhirChoiceTypes {
  ...
  /**
   * A FHIR choice type — one of: [AttachmentFhir] | [IdentifierFhir] | [ReferenceFhir] | [UriFhir]
   *
   * The choice type for:
   * - `Citation.citedArtifact.relatesTo.target`
   * - `Citation.relatesTo.target`
   */
  public sealed interface AttachmentOrIdentifierOrReferenceOrUri {
    public typealias Attachment = AttachmentFhir
  ...
  /**
   * A FHIR choice type — one of: [CanonicalFhir] | [CodeableConceptFhir] | [ExpressionFhir] |
   * [ReferenceFhir]
   *
   * The choice type for:
   * - `EvidenceVariable.characteristic.definition`
   */
  public sealed interface CanonicalOrCodeableConceptOrExpressionOrReference {
    public typealias Canonical = CanonicalFhir
   ...
   * [CodeableReferenceFhir] | [CodingFhir] | [ContactDetailFhir] | [ContactPointFhir] |
   * [ContributorFhir] | [CountBox] | [DataRequirementFhir] | [DateFhir] | [DateTimeFhir] |
   * [DecimalFhir] | [DistanceBox] | [DosageFhir] | [DurationBox] | [ExpressionFhir] |
   * [HumanNameFhir] | [IdBox] | [IdentifierFhir] | [InstantFhir] | [IntegerBox] | [MarkdownBox] |
   * [MoneyFhir] | [OidBox] | [ParameterDefinitionFhir] | [PeriodFhir] | [PositiveIntBox] |
   * [QuantityBox] | [RangeFhir] | [RatioFhir] | [RatioRangeFhir] | [ReferenceFhir] |
   * [RelatedArtifactFhir] | [SampledDataFhir] | [SignatureFhir] | [StringBox] | [TimeFhir] |
   * [TimingFhir] | [TriggerDefinitionFhir] | [UnsignedIntBox] | [UriBox] | [UrlBox] |
   * [UsageContextFhir] | [UuidBox]
   *
   * The choice type for:
   ...
   */
  public sealed interface NutritionProductProductCharacteristicValueChoice {
    public typealias Attachment = AttachmentFhir
   ...
   * - `Task.output.value`
   */
  public sealed interface ParametersParameterValueChoice {
    public typealias Address = AddressFhir
  ...
  /**
   * A FHIR choice type — one of: [RatioFhir] | [RatioRangeFhir]
   *
   * The choice type for:
   ...
   */
  public sealed interface RatioOrRatioRange {
    public typealias Ratio = RatioFhir
