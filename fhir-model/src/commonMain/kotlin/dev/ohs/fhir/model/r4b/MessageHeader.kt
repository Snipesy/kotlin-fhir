...
public data class MessageHeader(
  ...
  public data class Response(
    ...
    public class Builder(
      /** The MessageHeader.id of the message to which this message is a response. */
      public var identifier: Id.Builder,
      /**
  ...
  public class Builder(
     ...
     * and therefore cannot differentiate based on source endpoint / authentication alone.
     */
     ...
     * more than one candidate, pick the most proximal to the message. Can provide other enterers in
     * extensions.
     *
     * Usually only for the request but can be used in a response.
     */
