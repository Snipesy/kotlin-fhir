...
internal object BundleSerializer : KSerializer<Bundle> {
  ...
  internal fun deserializeInternal(
    ...
    while (true) {
      ...
      when (i - descriptorOffset) {
        ...
        16 ->
          issues = decoder.decodeNullableSerializableElement(descriptor, i, Hoisted.issuesSer, null)
  ...
  internal fun serializeInternal(
    ...
    (value.issues)?.let {
      encoder.encodeSerializableElement(descriptor, 16 + descriptorOffset, Hoisted.issuesSer, it)
    }
  }
  ...
  private object Hoisted {
    ...
    public val issuesSer: KSerializer<Resource> = Resource.serializer()
  }
}
