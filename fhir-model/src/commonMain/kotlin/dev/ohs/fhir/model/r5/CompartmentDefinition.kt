...
public data class CompartmentDefinition(
   ...
   */
  public val versionAlgorithm: CompartmentDefinition.VersionAlgorithm? = null,
  /**
  ...
  public data class Resource(
     ...
     */
    public val startParam: Uri? = null,
    /**
    ...
    public class Builder(
       ...
       * If no search parameters are listed, then the resource is not linked to the compartment.
       */
      public var `param`: MutableList<String.Builder> = mutableListOf()
       ...
       * [Patient.$everything](patient-operation-everything.html)).
       */
      public var startParam: Uri.Builder? = null

      /**
       * Search Parameter for mapping requests made with $everything.end (e.g. on
       * [Patient.$everything](patient-operation-everything.html)).
       */
      public var endParam: Uri.Builder? = null
  ...
  public class Builder(
    /**
     * An absolute URI that is used to identify this compartment definition when it is referenced in
     ...
     * compartment related syntax.
     */
    public var search: Boolean.Builder,
     ...
     * by the compartment definition author and is not expected to be globally unique. For example,
     ...
     * reference to a particular business version of the compartment definition with the format
    ...
    /**
     * The date (and optionally time) when the compartment definition was last significantly
     ...
     * resource may be a secondary representation of the compartment definition. Additional specific
     ...
     * maintenance of the compartment definition.
     *
     * Usually an organization but may be an individual. The publisher (or steward) of the
     * compartment definition is the organization or individual primarily responsible for the
     * maintenance and upkeep of the compartment definition. This is not necessarily the same
     * individual or organization that developed and initially authored the content. The publisher
     * is the primary point of contact for questions or issues with the compartment definition. This
     ...
     * etc. It is not a rendering of the compartment definition as conveyed in the 'text' field of
     * the resource itself. This item SHOULD be populated unless the information is available from
     * context (e.g. the language of the compartment definition is presumed to be the predominant
     * language in the place the compartment definition was created).
     */
    ...
    override fun build(): CompartmentDefinition =
