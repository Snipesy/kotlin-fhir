...
import dev.ohs.fhir.model.r4.serializers.SubstanceReferenceInformationClassificationSerializer
...
/** Todo. */
@Serializable(with = SubstanceReferenceInformationSerializer::class)
...
public data class SubstanceReferenceInformation(
  ...
  public data class Gene(
    ...
    public class Builder() {
      ...
      /** Todo. */
      public var geneSequenceOrigin: CodeableConcept.Builder? = null

      /** Todo. */
      public var gene: CodeableConcept.Builder? = null
  ...
  public data class GeneElement(
    ...
    public class Builder() {
      ...
      /** Todo. */
      public var element: Identifier.Builder? = null
  ...
  /** Todo. */
  @Serializable(with = SubstanceReferenceInformationClassificationSerializer::class)
  ...
  public data class Target(
    ...
    public class Builder() {
      ...
      /** Todo. */
      public var target: Identifier.Builder? = null

      /** Todo. */
      public var type: CodeableConcept.Builder? = null

      /** Todo. */
      public var interaction: CodeableConcept.Builder? = null

      /** Todo. */
      public var organism: CodeableConcept.Builder? = null
  ...
  public class Builder() : DomainResource.Builder() {
    ...
    /** Todo. */
    public var gene: MutableList<Gene.Builder> = mutableListOf()

    /** Todo. */
    public var geneElement: MutableList<GeneElement.Builder> = mutableListOf()
    ...
    override fun build(): SubstanceReferenceInformation =
