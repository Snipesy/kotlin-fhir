...
import dev.ohs.fhir.model.r5.serializers.NutritionOrderEnteralFormulaAdditiveSerializer
import dev.ohs.fhir.model.r5.serializers.NutritionOrderEnteralFormulaAdministrationScheduleSerializer
import dev.ohs.fhir.model.r5.serializers.NutritionOrderEnteralFormulaAdministrationSerializer
import dev.ohs.fhir.model.r5.serializers.NutritionOrderEnteralFormulaSerializer
import dev.ohs.fhir.model.r5.serializers.NutritionOrderOralDietNutrientSerializer
import dev.ohs.fhir.model.r5.serializers.NutritionOrderOralDietScheduleSerializer
import dev.ohs.fhir.model.r5.serializers.NutritionOrderOralDietSerializer
import dev.ohs.fhir.model.r5.serializers.NutritionOrderOralDietTextureSerializer
import dev.ohs.fhir.model.r5.serializers.NutritionOrderSerializer
import dev.ohs.fhir.model.r5.serializers.NutritionOrderSupplementScheduleSerializer
import dev.ohs.fhir.model.r5.serializers.NutritionOrderSupplementSerializer
...
public data class NutritionOrder(
  ...
  public val performer: List<CodeableReference> = listOf(),
  /**
  ...
  public data class OralDiet(
    ...
    public data class Schedule(
       ...
       */
      public val timing: List<Timing> = listOf(),
      /**
      ...
      public class Builder() {
         ...
         * for the combination of all schedules if more than one schedule is present.
         */
        public var timing: MutableList<Timing.Builder> = mutableListOf()

        /**
         * Indicates whether the product is only taken when needed within a specific dosing
         * schedule.
         */
        public var asNeeded: Boolean.Builder? = null

        /**
         * Indicates whether the product is only taken based on a precondition for taking the
         * product.
         */
    ...
    public class Builder() {
      ...
      /** Schedule information for an oral diet. */
      public var schedule: Schedule.Builder? = null
  ...
  public data class Supplement(
    ...
    public data class Schedule(
      ...
      public class Builder() {
        ...
        /**
         * The time period and frequency at which the supplement should be given. The supplement
         * should be given for the combination of all schedules if more than one schedule is
         * present.
         */
        public var timing: MutableList<Timing.Builder> = mutableListOf()
  ...
  public data class EnteralFormula(
     ...
     */
    public val deliveryDevice: List<CodeableReference> = listOf(),
    ...
    public data class Administration(
      ...
      public data class Schedule(
        ...
        public class Builder() {
          ...
          /**
           * The time period and frequency at which the enteral formula should be given. The enteral
           * formula should be given for the combination of all schedules if more than one schedule
           * is present.
           */
          public var timing: MutableList<Timing.Builder> = mutableListOf()

          /**
           * Indicates whether the enteral formula is only taken when needed within a specific
           * dosing schedule.
           */
          public var asNeeded: Boolean.Builder? = null
    ...
    public class Builder() {
       ...
       * soy-based infant formula.
       */
      public var baseFormulaType: CodeableReference.Builder? = null
      ...
      /**
       * The intended type of device that is to be used for the administration of the enteral
       * formula.
       */
      public var deliveryDevice: MutableList<CodeableReference.Builder> = mutableListOf()
  ...
  public class Builder(
    ...
    /** The specified desired performer of the nutrition order. */
    public var performer: MutableList<CodeableReference.Builder> = mutableListOf()
    ...
    /**
     * This modifier is used to convey whether a food item is allowed to be brought in by the
     * patient and/or family. If set to true, indicates that the receiving system does not need to
     * supply the food item.
     */
    public var outsideFoodAllowed: Boolean.Builder? = null
