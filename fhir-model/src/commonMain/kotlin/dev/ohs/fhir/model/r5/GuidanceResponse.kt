...
public data class GuidanceResponse(
  ...
  public class Builder(
     ...
     * scenarios, it may provide an indication of the cause for the response.
     *
     * Although this reference can be used to point to any resource, it is typically expected to
     * refer to subject-specific data appropriate to the subject of the guidance. For example,
     * patient-based decision support would be expected to reference patient-level data. In
     * addition, implementations should provide as much detail as possible by using the
     * [http://hl7.org/fhir/StructureDefinition/targetElement](http://hl7.org/fhir/extensions/StructureDefinition-targetElement.html)
     * and
     * [http://hl7.org/fhir/StructureDefinition/targetPath](http://hl7.org/fhir/extensions/StructureDefinition-targetPath.html)
     * extensions to indicate the specific elements relevant to providing the reason for the
     * guidance.
     */
     ...
     * provided by this element.
     */
    public var evaluationMessage: Reference.Builder? = null
