...
internal object ElementDefinitionExampleSerializer : KSerializer<ElementDefinition.Example> {
  ...
  private fun serializeInternal(encoder: CompositeEncoder, `value`: ElementDefinition.Example) {
    ...
    when (val choice = value.`value`) {
      ...
      is Markdown -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 24, it) }
        (choice.toElement())?.let {
      ...
      is PositiveInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 28, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 29, Hoisted.labelSer, it)
        }
      }
      is R4bString -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 30, it) }
        (choice.toElement())?.let {
      ...
      is UnsignedInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 34, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 35, Hoisted.labelSer, it)
        }
      }
      is Uri -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 36, it) }
        (choice.toElement())?.let {
      ...
      is Address -> {
        encoder.encodeSerializableElement(descriptor, 42, Hoisted.valueAddressSer, choice)
      }
      is Age -> {
        encoder.encodeSerializableElement(descriptor, 43, Hoisted.valueAgeSer, choice)
      }
      is Annotation -> {
        encoder.encodeSerializableElement(descriptor, 44, Hoisted.valueAnnotationSer, choice)
      }
      is Attachment -> {
        encoder.encodeSerializableElement(descriptor, 45, Hoisted.valueAttachmentSer, choice)
      }
      is CodeableConcept -> {
        encoder.encodeSerializableElement(descriptor, 46, Hoisted.valueCodeableConceptSer, choice)
      }
      is CodeableReference -> {
        encoder.encodeSerializableElement(descriptor, 47, Hoisted.valueCodeableReferenceSer, choice)
      }
      is Coding -> {
        encoder.encodeSerializableElement(descriptor, 48, Hoisted.valueCodingSer, choice)
      }
      is ContactPoint -> {
        encoder.encodeSerializableElement(descriptor, 49, Hoisted.valueContactPointSer, choice)
      }
      is Count -> {
        encoder.encodeSerializableElement(descriptor, 50, Hoisted.valueCountSer, choice)
      }
      is Distance -> {
        encoder.encodeSerializableElement(descriptor, 51, Hoisted.valueDistanceSer, choice)
      }
      is Duration -> {
        encoder.encodeSerializableElement(descriptor, 52, Hoisted.valueDurationSer, choice)
      }
      is HumanName -> {
        encoder.encodeSerializableElement(descriptor, 53, Hoisted.valueHumanNameSer, choice)
      }
      is Identifier -> {
        encoder.encodeSerializableElement(descriptor, 54, Hoisted.valueIdentifierSer, choice)
      }
      is Money -> {
        encoder.encodeSerializableElement(descriptor, 55, Hoisted.valueMoneySer, choice)
      }
      is Period -> {
        encoder.encodeSerializableElement(descriptor, 56, Hoisted.valuePeriodSer, choice)
      }
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 57, Hoisted.valueQuantitySer, choice)
      }
      is Range -> {
        encoder.encodeSerializableElement(descriptor, 58, Hoisted.valueRangeSer, choice)
      }
      is Ratio -> {
        encoder.encodeSerializableElement(descriptor, 59, Hoisted.valueRatioSer, choice)
      }
      is RatioRange -> {
        encoder.encodeSerializableElement(descriptor, 60, Hoisted.valueRatioRangeSer, choice)
      }
      is Reference -> {
        encoder.encodeSerializableElement(descriptor, 61, Hoisted.valueReferenceSer, choice)
      }
      is SampledData -> {
        encoder.encodeSerializableElement(descriptor, 62, Hoisted.valueSampledDataSer, choice)
      }
      is Signature -> {
        encoder.encodeSerializableElement(descriptor, 63, Hoisted.valueSignatureSer, choice)
      }
      is Timing -> {
        encoder.encodeSerializableElement(descriptor, 64, Hoisted.valueTimingSer, choice)
      }
      is ContactDetail -> {
        encoder.encodeSerializableElement(descriptor, 65, Hoisted.valueContactDetailSer, choice)
      }
      is Contributor -> {
        encoder.encodeSerializableElement(descriptor, 66, Hoisted.valueContributorSer, choice)
      }
      is DataRequirement -> {
        encoder.encodeSerializableElement(descriptor, 67, Hoisted.valueDataRequirementSer, choice)
      }
      is Expression -> {
        encoder.encodeSerializableElement(descriptor, 68, Hoisted.valueExpressionSer, choice)
      }
      ...
      is RelatedArtifact -> {
        encoder.encodeSerializableElement(descriptor, 70, Hoisted.valueRelatedArtifactSer, choice)
      }
      is TriggerDefinition -> {
        encoder.encodeSerializableElement(descriptor, 71, Hoisted.valueTriggerDefinitionSer, choice)
      }
      is UsageContext -> {
        encoder.encodeSerializableElement(descriptor, 72, Hoisted.valueUsageContextSer, choice)
      }
      is Dosage -> {
        encoder.encodeSerializableElement(descriptor, 73, Hoisted.valueDosageSer, choice)
      }
    }
  }
...
internal object ElementDefinitionConstraintSerializer : KSerializer<ElementDefinition.Constraint> {
  ...
  private fun deserializeInternal(decoder: CompositeDecoder): ElementDefinition.Constraint {
    ...
    return ElementDefinition.Constraint(
      ...
      human = R4bString.of(human, _human)!!,
...
internal object ElementDefinitionSerializer : KSerializer<ElementDefinition> {
  ...
  private fun serializeInternal(encoder: CompositeEncoder, `value`: ElementDefinition) {
    ...
    when (val choice = value.defaultValue) {
      null -> {}
      is Base64Binary -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 33, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 34, Hoisted.pathSer, it)
        }
      }
      is R4bBoolean -> {
        ((choice.value))?.let { encoder.encodeBooleanElement(descriptor, 35, it) }
        (choice.toElement())?.let {
      ...
      is Date -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 41, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 42, Hoisted.pathSer, it)
        }
      }
      is DateTime -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 43, it) }
        (choice.toElement())?.let {
      ...
      is Instant -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 49, it) }
        (choice.toElement())?.let {
      ...
      is Markdown -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 53, it) }
        (choice.toElement())?.let {
      ...
      is PositiveInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 57, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 58, Hoisted.pathSer, it)
        }
      }
      is R4bString -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 59, it) }
        (choice.toElement())?.let {
      ...
      is UnsignedInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 63, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 64, Hoisted.pathSer, it)
        }
      }
      is Uri -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 65, it) }
        (choice.toElement())?.let {
      ...
      is Address -> {
        encoder.encodeSerializableElement(descriptor, 71, Hoisted.defaultValueAddressSer, choice)
      }
      is Age -> {
        encoder.encodeSerializableElement(descriptor, 72, Hoisted.defaultValueAgeSer, choice)
      }
      is Annotation -> {
        encoder.encodeSerializableElement(descriptor, 73, Hoisted.defaultValueAnnotationSer, choice)
      }
      is Attachment -> {
        encoder.encodeSerializableElement(descriptor, 74, Hoisted.defaultValueAttachmentSer, choice)
      }
      is CodeableConcept -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Coding -> {
        encoder.encodeSerializableElement(descriptor, 77, Hoisted.codeSerInner, choice)
      }
      is ContactPoint -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Count -> {
        encoder.encodeSerializableElement(descriptor, 79, Hoisted.defaultValueCountSer, choice)
      }
      is Distance -> {
        encoder.encodeSerializableElement(descriptor, 80, Hoisted.defaultValueDistanceSer, choice)
      }
      is Duration -> {
        encoder.encodeSerializableElement(descriptor, 81, Hoisted.defaultValueDurationSer, choice)
      }
      is HumanName -> {
        encoder.encodeSerializableElement(descriptor, 82, Hoisted.defaultValueHumanNameSer, choice)
      }
      is Identifier -> {
        encoder.encodeSerializableElement(descriptor, 83, Hoisted.defaultValueIdentifierSer, choice)
      }
      is Money -> {
        encoder.encodeSerializableElement(descriptor, 84, Hoisted.defaultValueMoneySer, choice)
      }
      is Period -> {
        encoder.encodeSerializableElement(descriptor, 85, Hoisted.defaultValuePeriodSer, choice)
      }
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 86, Hoisted.defaultValueQuantitySer, choice)
      }
      is Range -> {
        encoder.encodeSerializableElement(descriptor, 87, Hoisted.defaultValueRangeSer, choice)
      }
      is Ratio -> {
        encoder.encodeSerializableElement(descriptor, 88, Hoisted.defaultValueRatioSer, choice)
      }
      is RatioRange -> {
        encoder.encodeSerializableElement(descriptor, 89, Hoisted.defaultValueRatioRangeSer, choice)
      }
      is Reference -> {
        encoder.encodeSerializableElement(descriptor, 90, Hoisted.defaultValueReferenceSer, choice)
      }
      is SampledData -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Signature -> {
        encoder.encodeSerializableElement(descriptor, 92, Hoisted.defaultValueSignatureSer, choice)
      }
      is Timing -> {
        encoder.encodeSerializableElement(descriptor, 93, Hoisted.defaultValueTimingSer, choice)
      }
      is ContactDetail -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Expression -> {
        encoder.encodeSerializableElement(descriptor, 97, Hoisted.defaultValueExpressionSer, choice)
      }
      is ParameterDefinition -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Dosage -> {
        encoder.encodeSerializableElement(descriptor, 102, Hoisted.defaultValueDosageSer, choice)
      }
    }
    ...
    when (val choice = value.fixed) {
      null -> {}
      is Base64Binary -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 107, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 108, Hoisted.pathSer, it)
        }
      }
      is R4bBoolean -> {
        ((choice.value))?.let { encoder.encodeBooleanElement(descriptor, 109, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 110, Hoisted.pathSer, it)
        }
      }
      is Canonical -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 111, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 112, Hoisted.pathSer, it)
        }
      }
      is Code -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 113, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 114, Hoisted.pathSer, it)
        }
      }
      is Date -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 115, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 116, Hoisted.pathSer, it)
        }
      }
      is DateTime -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 117, it) }
        (choice.toElement())?.let {
      ...
      is Id -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 121, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 122, Hoisted.pathSer, it)
        }
      }
      is Instant -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 123, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 124, Hoisted.pathSer, it)
        }
      }
      is Integer -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 125, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 126, Hoisted.pathSer, it)
        }
      }
      is Markdown -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 127, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 128, Hoisted.pathSer, it)
        }
      }
      is Oid -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 129, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 130, Hoisted.pathSer, it)
        }
      }
      is PositiveInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 131, it) }
        (choice.toElement())?.let {
      ...
      is Url -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 141, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 142, Hoisted.pathSer, it)
        }
      }
      is Uuid -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 143, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 144, Hoisted.pathSer, it)
        }
      }
      is Address -> {
        encoder.encodeSerializableElement(descriptor, 145, Hoisted.defaultValueAddressSer, choice)
      }
      is Age -> {
        encoder.encodeSerializableElement(descriptor, 146, Hoisted.defaultValueAgeSer, choice)
      }
      is Annotation -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Coding -> {
        encoder.encodeSerializableElement(descriptor, 151, Hoisted.codeSerInner, choice)
      }
      is ContactPoint -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Count -> {
        encoder.encodeSerializableElement(descriptor, 153, Hoisted.defaultValueCountSer, choice)
      }
      is Distance -> {
        encoder.encodeSerializableElement(descriptor, 154, Hoisted.defaultValueDistanceSer, choice)
      }
      is Duration -> {
        encoder.encodeSerializableElement(descriptor, 155, Hoisted.defaultValueDurationSer, choice)
      }
      is HumanName -> {
        encoder.encodeSerializableElement(descriptor, 156, Hoisted.defaultValueHumanNameSer, choice)
      }
      is Identifier -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Money -> {
        encoder.encodeSerializableElement(descriptor, 158, Hoisted.defaultValueMoneySer, choice)
      }
      is Period -> {
        encoder.encodeSerializableElement(descriptor, 159, Hoisted.defaultValuePeriodSer, choice)
      }
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 160, Hoisted.defaultValueQuantitySer, choice)
      }
      is Range -> {
        encoder.encodeSerializableElement(descriptor, 161, Hoisted.defaultValueRangeSer, choice)
      }
      is Ratio -> {
        encoder.encodeSerializableElement(descriptor, 162, Hoisted.defaultValueRatioSer, choice)
      }
      is RatioRange -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Reference -> {
        encoder.encodeSerializableElement(descriptor, 164, Hoisted.defaultValueReferenceSer, choice)
      }
      is SampledData -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Signature -> {
        encoder.encodeSerializableElement(descriptor, 166, Hoisted.defaultValueSignatureSer, choice)
      }
      is Timing -> {
        encoder.encodeSerializableElement(descriptor, 167, Hoisted.defaultValueTimingSer, choice)
      }
      is ContactDetail -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Dosage -> {
        encoder.encodeSerializableElement(descriptor, 176, Hoisted.defaultValueDosageSer, choice)
      }
    }
    when (val choice = value.pattern) {
      null -> {}
      is Base64Binary -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 177, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 178, Hoisted.pathSer, it)
        }
      }
      is R4bBoolean -> {
        ((choice.value))?.let { encoder.encodeBooleanElement(descriptor, 179, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 180, Hoisted.pathSer, it)
        }
      }
      is Canonical -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 181, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 182, Hoisted.pathSer, it)
        }
      }
      is Code -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 183, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 184, Hoisted.pathSer, it)
        }
      }
      is Date -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 185, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 186, Hoisted.pathSer, it)
        }
      }
      is DateTime -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 187, it) }
        (choice.toElement())?.let {
      ...
      is Instant -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 193, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 194, Hoisted.pathSer, it)
        }
      }
      is Integer -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 195, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 196, Hoisted.pathSer, it)
        }
      }
      is Markdown -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 197, it) }
        (choice.toElement())?.let {
      ...
      is PositiveInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 201, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 202, Hoisted.pathSer, it)
        }
      }
      is R4bString -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 203, it) }
        (choice.toElement())?.let {
      ...
      is UnsignedInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 207, it) }
        (choice.toElement())?.let {
      ...
      is Url -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 211, it) }
        (choice.toElement())?.let {
      ...
      is Address -> {
        encoder.encodeSerializableElement(descriptor, 215, Hoisted.defaultValueAddressSer, choice)
      }
      is Age -> {
        encoder.encodeSerializableElement(descriptor, 216, Hoisted.defaultValueAgeSer, choice)
      }
      is Annotation -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Coding -> {
        encoder.encodeSerializableElement(descriptor, 221, Hoisted.codeSerInner, choice)
      }
      is ContactPoint -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Count -> {
        encoder.encodeSerializableElement(descriptor, 223, Hoisted.defaultValueCountSer, choice)
      }
      is Distance -> {
        encoder.encodeSerializableElement(descriptor, 224, Hoisted.defaultValueDistanceSer, choice)
      }
      is Duration -> {
        encoder.encodeSerializableElement(descriptor, 225, Hoisted.defaultValueDurationSer, choice)
      }
      is HumanName -> {
        encoder.encodeSerializableElement(descriptor, 226, Hoisted.defaultValueHumanNameSer, choice)
      }
      is Identifier -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Money -> {
        encoder.encodeSerializableElement(descriptor, 228, Hoisted.defaultValueMoneySer, choice)
      }
      is Period -> {
        encoder.encodeSerializableElement(descriptor, 229, Hoisted.defaultValuePeriodSer, choice)
      }
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 230, Hoisted.defaultValueQuantitySer, choice)
      }
      is Range -> {
        encoder.encodeSerializableElement(descriptor, 231, Hoisted.defaultValueRangeSer, choice)
      }
      is Ratio -> {
        encoder.encodeSerializableElement(descriptor, 232, Hoisted.defaultValueRatioSer, choice)
      }
      is RatioRange -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Reference -> {
        encoder.encodeSerializableElement(descriptor, 234, Hoisted.defaultValueReferenceSer, choice)
      }
      is SampledData -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Signature -> {
        encoder.encodeSerializableElement(descriptor, 236, Hoisted.defaultValueSignatureSer, choice)
      }
      is Timing -> {
        encoder.encodeSerializableElement(descriptor, 237, Hoisted.defaultValueTimingSer, choice)
      }
      is ContactDetail -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Dosage -> {
        encoder.encodeSerializableElement(descriptor, 246, Hoisted.defaultValueDosageSer, choice)
      }
    }
    ...
    when (val choice = value.minValue) {
      null -> {}
      is Date -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 248, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 249, Hoisted.pathSer, it)
        }
      }
      is DateTime -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 250, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 251, Hoisted.pathSer, it)
        }
      }
      is Instant -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 252, it) }
        (choice.toElement())?.let {
      ...
      is Integer -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 258, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 259, Hoisted.pathSer, it)
        }
      }
      is PositiveInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 260, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 261, Hoisted.pathSer, it)
        }
      }
      is UnsignedInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 262, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 263, Hoisted.pathSer, it)
        }
      }
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 264, Hoisted.defaultValueQuantitySer, choice)
      }
    }
    when (val choice = value.maxValue) {
      null -> {}
      is Date -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 265, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 266, Hoisted.pathSer, it)
        }
      }
      is DateTime -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 267, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 268, Hoisted.pathSer, it)
        }
      }
      is Instant -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 269, it) }
        (choice.toElement())?.let {
      ...
      is Integer -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 275, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 276, Hoisted.pathSer, it)
        }
      }
      is PositiveInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 277, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 278, Hoisted.pathSer, it)
        }
      }
      is UnsignedInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 279, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 280, Hoisted.pathSer, it)
        }
      }
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 281, Hoisted.defaultValueQuantitySer, choice)
      }
    }
