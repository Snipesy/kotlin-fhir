    ...
    return ElementDefinition(
      ...
      defaultValue =
        (Base64Binary.of(defaultValueBase64Binary, _defaultValueBase64Binary)
          ...
          ?: (R4bString.of(defaultValueString, _defaultValueString))?.let { StringBox(it) }
      ...
      fixed =
        (Base64Binary.of(fixedBase64Binary, _fixedBase64Binary)
          ...
          ?: (R4bString.of(fixedString, _fixedString))?.let { StringBox(it) }
      ...
      pattern =
        (Base64Binary.of(patternBase64Binary, _patternBase64Binary)
          ...
          ?: (R4bString.of(patternString, _patternString))?.let { StringBox(it) }
