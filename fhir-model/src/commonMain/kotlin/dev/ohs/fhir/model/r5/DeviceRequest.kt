...
public data class DeviceRequest(
  ...
  public class Builder(
    ...
    /**
     * If true, indicates that the provider is asking for the patient to either stop using or to not
     * start using the specified device or category of devices. For example, the patient has
     * undergone surgery and the provider is indicating that the patient should not wear contact
     * lenses.
     *
     * If do not perform is not specified, the request is a positive request e.g. "do perform".
     * DeviceRequest.reasonCode includes the reason for marking the DeviceRequest as 'do not
     * perform'.
     */
     ...
     * patient, location).
     */
    public var performer: CodeableReference.Builder? = null
