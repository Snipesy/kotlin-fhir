...
import dev.ohs.fhir.model.r4b.serializers.DistanceSerializer
import kotlin.collections.List
import kotlin.collections.MutableList
import kotlinx.serialization.Serializable

/**
 * Base StructureDefinition for Distance Type: A length - a value with a unit that is a physical
 * distance.
 */
...
public data class Distance(
...
) : Element(), QuantityLike, FhirChoiceParticipants.DistanceChoices {
  ...
  public open class Builder() {
    ...
    public open fun build(): Distance =
      Distance(
        id = id,
