...
public data class Goal(
  ...
  public class Builder(
     ...
     * Indicates whose goal this is - patient goal, practitioner goal, etc.
     *
     * This is the individual responsible for establishing the goal, not necessarily who recorded
     * it. (For that, use the Provenance resource.).
     */
    public var expressedBy: Reference.Builder? = null
     ...
     * Note that this should not duplicate the goal status.
     */
    public var outcomeCode: MutableList<CodeableConcept.Builder> = mutableListOf()

    /**
     * Details of what's changed (or not changed).
     *
     * The goal outcome is independent of the outcome of the related activities. For example, if the
     * Goal is to achieve a target body weight of 150 lb and a care plan activity is defined to
     * diet, then the care plan’s activity outcome could be calories consumed whereas goal outcome
     * is an observation for the actual body weight measured.
     */
