...
public data class EventDefinition(
  ...
  public class Builder(
     ...
     * resource may be a secondary representation of the event definition. Additional specific dates
     ...
     * maintenance of the event definition.
     *
     * Usually an organization but may be an individual. The publisher (or steward) of the event
     * definition is the organization or individual primarily responsible for the maintenance and
     * upkeep of the event definition. This is not necessarily the same individual or organization
     ...
     * etc. It is not a rendering of the event definition as conveyed in the 'text' field of the
     * resource itself. This item SHOULD be populated unless the information is available from
     * context (e.g. the language of the event definition is presumed to be the predominant language
     * in the place the event definition was created).
     */
     ...
     *
     * The effective period for an event definition determines when the content is applicable for
     * usage and is independent of publication and review dates. For example, a definition intended
