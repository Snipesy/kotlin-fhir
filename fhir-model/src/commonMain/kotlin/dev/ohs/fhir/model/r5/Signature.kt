...
import dev.ohs.fhir.model.r5.serializers.SignatureSerializer
...
public data class Signature(
...
) : DataType(), FhirChoiceParticipants.SignatureChoices {
  ...
  public open class Builder() {
     ...
     * event. Also known as a &quot;Commitment Type Indication&quot;.
     */
    public open var type: MutableList<Coding.Builder> = mutableListOf()
     ...
     * This should agree with the information in the signature.
     */
    public open var `when`: Instant.Builder? = null
     ...
     * This should agree with the information in the signature.
     */
    public open var who: Reference.Builder? = null
