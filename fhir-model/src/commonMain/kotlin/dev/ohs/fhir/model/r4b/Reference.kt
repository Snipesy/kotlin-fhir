...
import dev.ohs.fhir.model.r4b.serializers.ReferenceSerializer
...
public data class Reference(
   ...
   * may be determined by inspection of the reference (e.g. a RESTful URL) or by resolving the
  ...
  public open class Builder() {
     ...
     * target may be determined by inspection of the reference (e.g. a RESTful URL) or by resolving
     * the target of the reference; if both the type and a reference is provided, the reference
     * SHALL resolve to a resource of the same type as that specified.
     */
