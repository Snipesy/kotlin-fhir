...
public data class ChargeItem(
   ...
   *
   * Often, the total price may be be calculated and recorded on the Invoice, but if a calculated
  ...
  override fun toBuilder(): Builder =
    with(this) {
      Builder(status, code.toBuilder(), subject.toBuilder()).apply {
        ...
        unitPriceComponent = this@with.unitPriceComponent?.toBuilder()
        totalPriceComponent = this@with.totalPriceComponent?.toBuilder()
  ...
  public class Builder(
     ...
     * be handled by finance systems.
     *
     * This ChargeItem may be recorded during planning, execution or after the actual encounter
     * takes place.
     */
     ...
     * supported or not available, the unit price can be communicated in this property.
     */
    public var unitPriceComponent: MonetaryComponent.Builder? = null
     ...
     * property.
     */
    public var totalPriceComponent: MonetaryComponent.Builder? = null

    /**
     * If the list price or the rule-based factor associated with the code is overridden, this
     * attribute can capture a text to indicate the reason for this action.
     */
    public var overrideReason: CodeableConcept.Builder? = null
    ...
    /** Indicated the rendered service that caused this charge. */
    public var service: MutableList<CodeableReference.Builder> = mutableListOf()

    /**
     * Identifies the device, food, drug or other product being charged either by type code or
     * reference to an instance.
     */
    public var product: MutableList<CodeableReference.Builder> = mutableListOf()
    ...
    override fun build(): ChargeItem =
      ChargeItem(
        ...
        unitPriceComponent = unitPriceComponent?.build(),
        totalPriceComponent = totalPriceComponent?.build(),
