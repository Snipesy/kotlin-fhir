...
public data class ResearchDefinition(
  ...
  public class Builder(
     ...
     * instance of this research definition is (or will be) published. This URL can be the target of
     * a canonical reference. It SHALL remain the same when the research definition is stored on
     * different servers.
     *
    ...
    /**
     * A formal identifier that is used to identify this research definition when it is represented
     ...
     * data type, and can then identify this research definition outside of FHIR, where it is not
     ...
     * by the research definition author and is not expected to be globally unique. For example, it
     ...
     * reference to a particular business version of the research definition with the format
     * [url]|[version].
     */
    ...
    /**
     * A Boolean value to indicate that this research definition is authored for testing purposes
     ...
     * as the logic in the ResearchDefinitions is evaluated with respect to a particular subject.
     ...
     * addition, it should change when the substantive content of the research definition changes.
     *
     * Note that this is not the same as the resource last-modified-date, since the resource may be
     * a secondary representation of the research definition. Additional specific dates may be added
     ...
     * Usually an organization but may be an individual. The publisher (or steward) of the research
     * definition is the organization or individual primarily responsible for the maintenance and
     * upkeep of the research definition. This is not necessarily the same individual or
     * organization that developed and initially authored the content. The publisher is the primary
     * point of contact for questions or issues with the research definition. This item SHOULD be
     ...
     * perspective.
     *
     * This description can be used to capture details such as why the research definition was
     * built, comments about misuse, instructions for clinical use and interpretation, literature
     * references, examples from the paper world, etc. It is not a rendering of the research
     ...
     * definition is presumed to be the predominant language in the place the research definition
     * was created).
     */
     ...
     * A legal or geographic region in which the research definition is intended to be used.
     *
     * It may be possible for the research definition to be used in jurisdictions other than those
    ...
    /**
     * The period during which the research definition content was or is planned to be in active
     * use.
     *
     * The effective period for a research definition determines when the content is applicable for
    ...
    /**
     * A reference to a ResearchElementDefinition resource that defines the exposure for the
     * research.
     */
    public var exposure: Reference.Builder? = null

    /**
     * A reference to a ResearchElementDefinition resource that defines the exposureAlternative for
     * the research.
     */
    public var exposureAlternative: Reference.Builder? = null

    /**
     * A reference to a ResearchElementDefinition resomece that defines the outcome for the
     * research.
     */
    public var outcome: Reference.Builder? = null

    override fun build(): ResearchDefinition =
      ResearchDefinition(
        id = id,
        meta = meta?.build(),
