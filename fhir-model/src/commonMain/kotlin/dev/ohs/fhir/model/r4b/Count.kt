...
import dev.ohs.fhir.model.r4b.serializers.CountSerializer
import kotlin.collections.List
import kotlin.collections.MutableList
import kotlinx.serialization.Serializable

/**
 * Base StructureDefinition for Count Type: A measured amount (or an amount that can potentially be
 * measured). Note that measured amounts include amounts that are not precisely quantified,
...
) : Element(), QuantityLike, FhirChoiceParticipants.CountChoices {
