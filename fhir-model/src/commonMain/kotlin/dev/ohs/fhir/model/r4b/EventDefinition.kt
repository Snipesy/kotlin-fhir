...
public data class EventDefinition(
   ...
   * of this event definition is (or will be) published. This URL can be the target of a canonical
   ...
   * particular business version of the event definition with the format [url]|[version].
   */
   ...
   * it should change when the substantive content of the event definition changes.
   *
   * Note that this is not the same as the resource last-modified-date, since the resource may be a
   * secondary representation of the event definition. Additional specific dates may be added as
   ...
   * examples from the paper world, etc. It is not a rendering of the event definition as conveyed
   * in the 'text' field of the resource itself. This item SHOULD be populated unless the
   * information is available from context (e.g. the language of the event definition is presumed to
  ...
  override fun toBuilder(): Builder =
    with(this) {
      Builder(status, trigger.map { it.toBuilder() }.toMutableList()).apply {
        id = this@with.id
  ...
  public class Builder(
     ...
     * specified, the event fires whenever any one of the trigger conditions is met.
     */
    public var trigger: MutableList<TriggerDefinition.Builder>,
     ...
     * instance of this event definition is (or will be) published. This URL can be the target of a
     * canonical reference. It SHALL remain the same when the event definition is stored on
     * different servers.
     *
     ...
     * data type, and can then identify this event definition outside of FHIR, where it is not
     ...
     * by the event definition author and is not expected to be globally unique. For example, it
     ...
     * a secondary representation of the event definition. Additional specific dates may be added as
     ...
     * upkeep of the event definition. This is not necessarily the same individual or organization
     * that developed and initially authored the content. The publisher is the primary point of
     * contact for questions or issues with the event definition. This item SHOULD be populated
     ...
     * references, examples from the paper world, etc. It is not a rendering of the event definition
     * as conveyed in the 'text' field of the resource itself. This item SHOULD be populated unless
     * the information is available from context (e.g. the language of the event definition is
     * presumed to be the predominant language in the place the event definition was created).
     */
     ...
     * The period during which the event definition content was or is planned to be in active use.
     *
     * The effective period for a event definition determines when the content is applicable for
    ...
    override fun build(): EventDefinition =
      EventDefinition(
        id = id,
        meta = meta?.build(),
