...
import dev.ohs.fhir.model.r5.serializers.GraphDefinitionLinkCompartmentSerializer
...
public data class GraphDefinition(
   ...
   */
  public val versionAlgorithm: GraphDefinition.VersionAlgorithm? = null,
  /**
   ...
   */
  public val start: Id? = null,
  /** Potential target for the link. */
  public val node: List<Node> = listOf(),
  ...
  public data class Node(
    ...
    public fun toBuilder(): Builder =
      with(this) {
        Builder(nodeId.toBuilder(), type).apply {
          id = this@with.id
          extension = this@with.extension.map { it.toBuilder() }.toMutableList()
          modifierExtension = this@with.modifierExtension.map { it.toBuilder() }.toMutableList()
          description = this@with.description?.toBuilder()
  ...
  public class Builder(
     ...
     * resource may be a secondary representation of the graph definition. Additional specific dates
     ...
     * maintenance of the graph definition.
     *
     * Usually an organization but may be an individual. The publisher (or steward) of the graph
     * definition is the organization or individual primarily responsible for the maintenance and
     * upkeep of the graph definition. This is not necessarily the same individual or organization
     ...
     * etc. It is not a rendering of the graph definition as conveyed in the 'text' field of the
     * resource itself. This item SHOULD be populated unless the information is available from
     * context (e.g. the language of the graph definition is presumed to be the predominant language
     * in the place the graph definition was created).
     */
    ...
    /**
     * A copyright statement relating to the graph definition and/or its contents. Copyright
     * statements are generally legal restrictions on the use and publishing of the graph
     * definition.
     *
     * ...
     */
    ...
    /**
     * The Node at which instances of this graph start. If there is no nominated start, the graph
     * can start at any of the nodes.
     */
    public var start: Id.Builder? = null

    /** Potential target for the link. */
    public var node: MutableList<Node.Builder> = mutableListOf()
