...
internal object ElementDefinitionExampleSerializer : KSerializer<ElementDefinition.Example> {
  ...
  private fun serializeInternal(encoder: CompositeEncoder, `value`: ElementDefinition.Example) {
    ...
    when (val choice = value.`value`) {
      ...
      is Count -> {
        encoder.encodeSerializableElement(descriptor, 49, Hoisted.valueCountSer, choice)
      }
      is Distance -> {
        encoder.encodeSerializableElement(descriptor, 50, Hoisted.valueDistanceSer, choice)
      }
      is Duration -> {
        encoder.encodeSerializableElement(descriptor, 51, Hoisted.valueDurationSer, choice)
      }
      is HumanName -> {
      ...
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 56, Hoisted.valueQuantitySer, choice)
      }
      is Range -> {
      ...
      is Reference -> {
        encoder.encodeSerializableElement(descriptor, 59, Hoisted.valueReferenceSer, choice)
      }
      is SampledData -> {
        encoder.encodeSerializableElement(descriptor, 60, Hoisted.valueSampledDataSer, choice)
      }
      is Signature -> {
        encoder.encodeSerializableElement(descriptor, 61, Hoisted.valueSignatureSer, choice)
      }
      is Timing -> {
        encoder.encodeSerializableElement(descriptor, 62, Hoisted.valueTimingSer, choice)
      }
      is ContactDetail -> {
        encoder.encodeSerializableElement(descriptor, 63, Hoisted.valueContactDetailSer, choice)
      }
      is Contributor -> {
        encoder.encodeSerializableElement(descriptor, 64, Hoisted.valueContributorSer, choice)
      }
      is DataRequirement -> {
        encoder.encodeSerializableElement(descriptor, 65, Hoisted.valueDataRequirementSer, choice)
      }
      is Expression -> {
        encoder.encodeSerializableElement(descriptor, 66, Hoisted.valueExpressionSer, choice)
      }
      ...
      is RelatedArtifact -> {
        encoder.encodeSerializableElement(descriptor, 68, Hoisted.valueRelatedArtifactSer, choice)
      }
      is TriggerDefinition -> {
        encoder.encodeSerializableElement(descriptor, 69, Hoisted.valueTriggerDefinitionSer, choice)
      }
      is UsageContext -> {
        encoder.encodeSerializableElement(descriptor, 70, Hoisted.valueUsageContextSer, choice)
      }
      is Dosage -> {
        encoder.encodeSerializableElement(descriptor, 71, Hoisted.valueDosageSer, choice)
      }
      is Meta -> {
        encoder.encodeSerializableElement(descriptor, 72, Hoisted.valueMetaSer, choice)
      }
    }
  }
...
internal object ElementDefinitionSerializer : KSerializer<ElementDefinition> {
  ...
  private fun serializeInternal(encoder: CompositeEncoder, `value`: ElementDefinition) {
    ...
    when (val choice = value.defaultValue) {
      ...
      is Coding -> {
        encoder.encodeSerializableElement(descriptor, 76, Hoisted.codeSerInner, choice)
      }
      is ContactPoint -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Count -> {
        encoder.encodeSerializableElement(descriptor, 78, Hoisted.defaultValueCountSer, choice)
      }
      is Distance -> {
        encoder.encodeSerializableElement(descriptor, 79, Hoisted.defaultValueDistanceSer, choice)
      }
      is Duration -> {
        encoder.encodeSerializableElement(descriptor, 80, Hoisted.defaultValueDurationSer, choice)
      }
      is HumanName -> {
        encoder.encodeSerializableElement(descriptor, 81, Hoisted.defaultValueHumanNameSer, choice)
      }
      is Identifier -> {
        encoder.encodeSerializableElement(descriptor, 82, Hoisted.defaultValueIdentifierSer, choice)
      }
      is Money -> {
        encoder.encodeSerializableElement(descriptor, 83, Hoisted.defaultValueMoneySer, choice)
      }
      is Period -> {
        encoder.encodeSerializableElement(descriptor, 84, Hoisted.defaultValuePeriodSer, choice)
      }
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 85, Hoisted.defaultValueQuantitySer, choice)
      }
      is Range -> {
        encoder.encodeSerializableElement(descriptor, 86, Hoisted.defaultValueRangeSer, choice)
      }
      is Ratio -> {
        encoder.encodeSerializableElement(descriptor, 87, Hoisted.defaultValueRatioSer, choice)
      }
      is Reference -> {
        encoder.encodeSerializableElement(descriptor, 88, Hoisted.defaultValueReferenceSer, choice)
      }
      is SampledData -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Signature -> {
        encoder.encodeSerializableElement(descriptor, 90, Hoisted.defaultValueSignatureSer, choice)
      }
      is Timing -> {
        encoder.encodeSerializableElement(descriptor, 91, Hoisted.defaultValueTimingSer, choice)
      }
      is ContactDetail -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Expression -> {
        encoder.encodeSerializableElement(descriptor, 95, Hoisted.defaultValueExpressionSer, choice)
      }
      is ParameterDefinition -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Dosage -> {
        encoder.encodeSerializableElement(descriptor, 100, Hoisted.defaultValueDosageSer, choice)
      }
      is Meta -> {
        encoder.encodeSerializableElement(descriptor, 101, Hoisted.defaultValueMetaSer, choice)
      }
    }
    ...
    when (val choice = value.fixed) {
      null -> {}
      is Base64Binary -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 106, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 107, Hoisted.pathSer, it)
        }
      }
      is R4Boolean -> {
        ((choice.value))?.let { encoder.encodeBooleanElement(descriptor, 108, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 109, Hoisted.pathSer, it)
        }
      }
      is Canonical -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 110, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 111, Hoisted.pathSer, it)
        }
      }
      is Code -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 112, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 113, Hoisted.pathSer, it)
        }
      }
      is Date -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 114, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 115, Hoisted.pathSer, it)
        }
      }
      is DateTime -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 116, it) }
        (choice.toElement())?.let {
      ...
      is Id -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 120, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 121, Hoisted.pathSer, it)
        }
      }
      is Instant -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 122, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 123, Hoisted.pathSer, it)
        }
      }
      is Integer -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 124, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 125, Hoisted.pathSer, it)
        }
      }
      is Markdown -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 126, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 127, Hoisted.pathSer, it)
        }
      }
      is Oid -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 128, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 129, Hoisted.pathSer, it)
        }
      }
      is PositiveInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 130, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 131, Hoisted.pathSer, it)
        }
      }
      is R4String -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 132, it) }
        (choice.toElement())?.let {
      ...
      is UnsignedInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 136, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 137, Hoisted.pathSer, it)
        }
      }
      is Uri -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 138, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 139, Hoisted.pathSer, it)
        }
      }
      is Url -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 140, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 141, Hoisted.pathSer, it)
        }
      }
      is Uuid -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 142, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 143, Hoisted.pathSer, it)
        }
      }
      is Address -> {
        encoder.encodeSerializableElement(descriptor, 144, Hoisted.defaultValueAddressSer, choice)
      }
      is Age -> {
        encoder.encodeSerializableElement(descriptor, 145, Hoisted.defaultValueAgeSer, choice)
      }
      is Annotation -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Coding -> {
        encoder.encodeSerializableElement(descriptor, 149, Hoisted.codeSerInner, choice)
      }
      is ContactPoint -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Count -> {
        encoder.encodeSerializableElement(descriptor, 151, Hoisted.defaultValueCountSer, choice)
      }
      is Distance -> {
        encoder.encodeSerializableElement(descriptor, 152, Hoisted.defaultValueDistanceSer, choice)
      }
      is Duration -> {
        encoder.encodeSerializableElement(descriptor, 153, Hoisted.defaultValueDurationSer, choice)
      }
      is HumanName -> {
        encoder.encodeSerializableElement(descriptor, 154, Hoisted.defaultValueHumanNameSer, choice)
      }
      is Identifier -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Money -> {
        encoder.encodeSerializableElement(descriptor, 156, Hoisted.defaultValueMoneySer, choice)
      }
      is Period -> {
        encoder.encodeSerializableElement(descriptor, 157, Hoisted.defaultValuePeriodSer, choice)
      }
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 158, Hoisted.defaultValueQuantitySer, choice)
      }
      is Range -> {
        encoder.encodeSerializableElement(descriptor, 159, Hoisted.defaultValueRangeSer, choice)
      }
      is Ratio -> {
        encoder.encodeSerializableElement(descriptor, 160, Hoisted.defaultValueRatioSer, choice)
      }
      is Reference -> {
        encoder.encodeSerializableElement(descriptor, 161, Hoisted.defaultValueReferenceSer, choice)
      }
      is SampledData -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Signature -> {
        encoder.encodeSerializableElement(descriptor, 163, Hoisted.defaultValueSignatureSer, choice)
      }
      is Timing -> {
        encoder.encodeSerializableElement(descriptor, 164, Hoisted.defaultValueTimingSer, choice)
      }
      is ContactDetail -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Dosage -> {
        encoder.encodeSerializableElement(descriptor, 173, Hoisted.defaultValueDosageSer, choice)
      }
      is Meta -> {
        encoder.encodeSerializableElement(descriptor, 174, Hoisted.defaultValueMetaSer, choice)
      }
    }
    when (val choice = value.pattern) {
      null -> {}
      is Base64Binary -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 175, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 176, Hoisted.pathSer, it)
        }
      }
      is R4Boolean -> {
        ((choice.value))?.let { encoder.encodeBooleanElement(descriptor, 177, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 178, Hoisted.pathSer, it)
        }
      }
      is Canonical -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 179, it) }
        (choice.toElement())?.let {
      ...
      is Date -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 183, it) }
        (choice.toElement())?.let {
      ...
      is Instant -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 191, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 192, Hoisted.pathSer, it)
        }
      }
      is Integer -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 193, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 194, Hoisted.pathSer, it)
        }
      }
      is Markdown -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 195, it) }
        (choice.toElement())?.let {
      ...
      is PositiveInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 199, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 200, Hoisted.pathSer, it)
        }
      }
      is R4String -> {
        ((choice.value))?.let { encoder.encodeStringElement(descriptor, 201, it) }
        (choice.toElement())?.let {
      ...
      is UnsignedInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 205, it) }
        (choice.toElement())?.let {
      ...
      is Address -> {
        encoder.encodeSerializableElement(descriptor, 213, Hoisted.defaultValueAddressSer, choice)
      }
      is Age -> {
        encoder.encodeSerializableElement(descriptor, 214, Hoisted.defaultValueAgeSer, choice)
      }
      is Annotation -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Coding -> {
        encoder.encodeSerializableElement(descriptor, 218, Hoisted.codeSerInner, choice)
      }
      is ContactPoint -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Count -> {
        encoder.encodeSerializableElement(descriptor, 220, Hoisted.defaultValueCountSer, choice)
      }
      is Distance -> {
        encoder.encodeSerializableElement(descriptor, 221, Hoisted.defaultValueDistanceSer, choice)
      }
      is Duration -> {
        encoder.encodeSerializableElement(descriptor, 222, Hoisted.defaultValueDurationSer, choice)
      }
      is HumanName -> {
        encoder.encodeSerializableElement(descriptor, 223, Hoisted.defaultValueHumanNameSer, choice)
      }
      is Identifier -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Money -> {
        encoder.encodeSerializableElement(descriptor, 225, Hoisted.defaultValueMoneySer, choice)
      }
      is Period -> {
        encoder.encodeSerializableElement(descriptor, 226, Hoisted.defaultValuePeriodSer, choice)
      }
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 227, Hoisted.defaultValueQuantitySer, choice)
      }
      is Range -> {
        encoder.encodeSerializableElement(descriptor, 228, Hoisted.defaultValueRangeSer, choice)
      }
      is Ratio -> {
        encoder.encodeSerializableElement(descriptor, 229, Hoisted.defaultValueRatioSer, choice)
      }
      is Reference -> {
        encoder.encodeSerializableElement(descriptor, 230, Hoisted.defaultValueReferenceSer, choice)
      }
      is SampledData -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Signature -> {
        encoder.encodeSerializableElement(descriptor, 232, Hoisted.defaultValueSignatureSer, choice)
      }
      is Timing -> {
        encoder.encodeSerializableElement(descriptor, 233, Hoisted.defaultValueTimingSer, choice)
      }
      is ContactDetail -> {
        encoder.encodeSerializableElement(
          descriptor,
      ...
      is Dosage -> {
        encoder.encodeSerializableElement(descriptor, 242, Hoisted.defaultValueDosageSer, choice)
      }
      is Meta -> {
        encoder.encodeSerializableElement(descriptor, 243, Hoisted.defaultValueMetaSer, choice)
      }
    }
    ...
    when (val choice = value.minValue) {
      null -> {}
      is Date -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 245, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 246, Hoisted.pathSer, it)
        }
      }
      is DateTime -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 247, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 248, Hoisted.pathSer, it)
        }
      }
      is Instant -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 249, it) }
        (choice.toElement())?.let {
      ...
      is Integer -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 255, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 256, Hoisted.pathSer, it)
        }
      }
      is PositiveInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 257, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 258, Hoisted.pathSer, it)
        }
      }
      is UnsignedInt -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 259, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 260, Hoisted.pathSer, it)
        }
      }
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 261, Hoisted.defaultValueQuantitySer, choice)
      }
    }
    when (val choice = value.maxValue) {
      null -> {}
      is Date -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 262, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 263, Hoisted.pathSer, it)
        }
      }
      is DateTime -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 264, it) }
        (choice.toElement())?.let {
          encoder.encodeSerializableElement(descriptor, 265, Hoisted.pathSer, it)
        }
      }
      is Instant -> {
        ((choice.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 266, it) }
        (choice.toElement())?.let {
      ...
      is Integer -> {
        ((choice.value))?.let { encoder.encodeIntElement(descriptor, 272, it) }
        (choice.toElement())?.let {
      ...
      is Quantity -> {
        encoder.encodeSerializableElement(descriptor, 278, Hoisted.defaultValueQuantitySer, choice)
      }
    }
