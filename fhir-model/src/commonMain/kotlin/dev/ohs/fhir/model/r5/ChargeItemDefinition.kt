...
public data class ChargeItemDefinition(
   ...
   * charge item definition is (or will be) published. This URL can be the target of a canonical
   * reference. It SHALL remain the same when the charge item definition is stored on different
   * servers.
   *
  ...
  /**
   * The date (and optionally time) when the charge item definition was last significantly changed.
   ...
   * may be a secondary representation of the charge item definition. Additional specific dates may
   ...
   * is not a rendering of the charge item definition as conveyed in the 'text' field of the
   * resource itself. This item SHOULD be populated unless the information is available from context
   * (e.g. the language of the charge item definition is presumed to be the predominant language in
   * the place the charge item definition was created).
   */
   ...
   * has.
   *
   * This element does not describe the usage of the charge item definition. Instead, it provides
  ...
  public data class Applicability(
    ...
    public class Builder() {
       ...
       */
      public var condition: Expression.Builder? = null
  ...
  public class Builder(
    ...
    /**
     * The date (and optionally time) when the charge item definition was last significantly
     * changed. The date must change when the business version changes and it must change if the
     * status code changes. In addition, it should change when the substantive content of the charge
     * item definition changes.
     *
     * The date is often not tracked until the resource is published, but may be present on draft
     * content. Note that this is not the same as the resource last-modified-date, since the
     * resource may be a secondary representation of the charge item definition. Additional specific
     ...
     * maintenance of the charge item definition.
     *
     ...
     * etc. It is not a rendering of the charge item definition as conveyed in the 'text' field of
     * the resource itself. This item SHOULD be populated unless the information is available from
     * context (e.g. the language of the charge item definition is presumed to be the predominant
     * language in the place the charge item definition was created).
     */
