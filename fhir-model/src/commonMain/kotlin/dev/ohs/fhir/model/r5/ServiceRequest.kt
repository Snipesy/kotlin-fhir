...
public data class ServiceRequest(
   ...
   */
  public val orderDetail: List<OrderDetail> = listOf(),
  /**
   ...
   */
  public val location: List<CodeableReference> = listOf(),
  /**
   ...
   * element.
   */
  public val supportingInfo: List<CodeableReference> = listOf(),
  /**
  ...
  public val patientInstruction: List<PatientInstruction> = listOf(),
  /**
  ...
  public data class OrderDetail(
    ...
    public fun toBuilder(): Builder =
      with(this) {
        Builder(parameter.map { it.toBuilder() }.toMutableList()).apply {
          id = this@with.id
          extension = this@with.extension.map { it.toBuilder() }.toMutableList()
          modifierExtension = this@with.modifierExtension.map { it.toBuilder() }.toMutableList()
          parameterFocus = this@with.parameterFocus?.toBuilder()
        }
      }
  ...
  public class Builder(
     ...
     *
     * The status is generally fully in the control of the requester - they determine whether the
     * order is draft or active and, after it has been activated, competed, revoked or placed
     * on-hold. States relating to the activities of the performer are reflected on either the
     * corresponding event (see [Event Pattern](event.html) for general discussion) or using the
     ...
     */
    public var code: CodeableReference.Builder? = null
     ...
     * services, use the `supportingInformation` element.
     */
    public var orderDetail: MutableList<OrderDetail.Builder> = mutableListOf()
    ...
    /**
     * The actual focus of a service request when it is not the subject of record representing
     * something or someone associated with the subject such as a spouse, parent, fetus, or donor.
     * The focus of a service request could also be an existing condition, an intervention, the
     * subject's diet, another service request on the subject, or a body structure such as tumor or
     * implanted device.
     */
     ...
     * without any preference regardless of order. If order of preference is needed use the
     * [http://hl7.org/fhir/StructureDefinition/request-performerOrder](http://hl7.org/fhir/extensions/StructureDefinition-request-performerOrder.html).
     * Use CareTeam to represent a group of performers (for example, Practitioner A *and*
     * Practitioner B).
     */
     ...
     * form. E.g. at home or nursing day care center.
     */
    public var location: MutableList<CodeableReference.Builder> = mutableListOf()
     ...
     * element.
     */
    public var supportingInfo: MutableList<CodeableReference.Builder> = mutableListOf()

    /**
     * One or more specimens that the laboratory procedure will use.
     *
     * The purpose of the ServiceRequest.specimen is to reflect the actual specimen that the
     * requested test/procedure is asked to be performed on, whether the lab already has it or not.
     * References to specimens for purposes other than to perform a test/procedure on should be made
     * using the ServiceRequest.supportingInfo or the Specimen.parent where the Specimen.parent
     * would enable descendency and ServiceRequest.supportingInfo a general reference for context.
     */
    ...
    /** Instructions in terms that are understood by the patient or consumer. */
    public var patientInstruction: MutableList<PatientInstruction.Builder> = mutableListOf()
