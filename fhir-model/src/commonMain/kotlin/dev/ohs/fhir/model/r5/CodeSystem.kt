...
public data class CodeSystem(
  ...
  public class Builder(
    ...
    /**
     * Indicates the mechanism used to compare versions to determine which CodeSystem is more
     * current.
     *
     * If set as a string, this is a FHIRPath expression that has two additional context variables
     * passed in - %version1 and %version2 and will return a negative number if version1 is newer, a
     ...
     * resource may be a secondary representation of the code system. Additional specific dates may
     ...
     * etc. It is not a rendering of the code system as conveyed in the 'text' field of the resource
     * itself. This item SHOULD be populated unless the information is available from context (e.g.
     * the language of the code system is presumed to be the predominant language in the place the
     * code system was created).
     */
     ...
     * review of some aspect of the CodeSystem.
     *
     * See guidance around (not) making local changes to elements
     * [here](canonicalresource.html#localization).
     */
    ...
    /**
     * Canonical reference to the value set that contains all codes in the code system independent
     * of code status.
     *
     * The definition of the value set SHALL include all codes from this code system, independent of
     * concept status, and only codes from this code system. It SHALL be immutable, and operations
     ...
     *
     * Multiple occurrences of CodeSystem.concept.property may occur for a CodeSystem.property where
     * CodeSystem.concept.property.code is the same and CodeSystem.concept.property.value differs.
     * For example: multiple designations for a single concept.
     */
    public var `property`: MutableList<Property.Builder> = mutableListOf()
