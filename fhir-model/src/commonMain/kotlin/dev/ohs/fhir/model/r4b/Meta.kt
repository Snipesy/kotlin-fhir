...
import dev.ohs.fhir.model.r4b.serializers.MetaSerializer
...
public data class Meta(
...
) : Element(), FhirChoiceTypes.ParametersParameterValueChoice {
  ...
  public open class Builder() {
     ...
     * message, database, etc.
     *
     * In the provenance resource, this corresponds to Provenance.entity.what[x]. The exact use of
     * the source (and the implied Provenance.entity.role) is left to implementer discretion. Only
     * one nominated source is allowed; for additional provenance details, a full Provenance
