...
public data class MessageDefinition(
  ...
  public class Builder(
     ...
     * addition, it should change when the substantive content of the message definition changes.
     *
     * Note that this is not the same as the resource last-modified-date, since the resource may be
     * a secondary representation of the message definition. Additional specific dates may be added
     ...
     * references, examples from the paper world, etc. It is not a rendering of the message
     * definition as conveyed in the 'text' field of the resource itself. This item SHOULD be
     * populated unless the information is available from context (e.g. the language of the message
     * definition is presumed to be the predominant language in the place the message definition was
     * created).
     */
    ...
    /**
     * Canonical reference to a GraphDefinition. If a URL is provided, it is the canonical reference
     * to a [GraphDefinition](graphdefinition.html) that it controls what resources are to be added
     * to the bundle when building the document. The GraphDefinition can also specify profiles that
     * apply to the various resources.
     */
    public var graph: MutableList<Canonical.Builder> = mutableListOf()
