...
public data class Practitioner(
  ...
  public class Builder() : DomainResource.Builder() {
     ...
     * practitioner to practice medicine within a certain locality.
     *
     * The PractitionerRole.specialty defines the functional role that they are practicing at a
     * given organization or location. Those specialties may or might not require a qualification,
     * and are not defined on the practitioner.
     */
     ...
     * correspondence/administrative purposes.
     *
     * The `PractitionerRole.communication` property should be used for publishing the languages
     * that a practitioner is able to communicate with patients (on a per Organization/Role basis).
     *
     * If no language is specified, this *implies* that the default local language is spoken. If you
     * need to convey proficiency for multiple modes, then you need multiple
     * Practitioner.Communication associations.
