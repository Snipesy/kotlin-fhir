...
import dev.ohs.fhir.model.r4b.serializers.IdentifierSerializer
import kotlin.collections.List
import kotlin.collections.MutableList
import kotlinx.serialization.Serializable

/**
 * Base StructureDefinition for Identifier Type: An identifier - identifies some entity uniquely and
...
public data class Identifier(
   ...
   * can be conveyed using the [Rendered Value extension](extension-rendered-value.html).
...
) : Element(), FhirChoiceParticipants.IdentifierChoices {
