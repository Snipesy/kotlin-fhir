...
import dev.ohs.fhir.model.r4.serializers.MedicinalProductContraindicationOtherTherapySerializer
 ...
 */
@Serializable(with = MedicinalProductContraindicationSerializer::class)
...
public data class MedicinalProductContraindication(
   ...
   * the indication.
   */
  public val therapeuticIndication: List<Reference> = listOf(),
  /**
  ...
  public class Builder() : DomainResource.Builder() {
    ...
    /** The disease, symptom or procedure for the contraindication. */
    public var disease: CodeableConcept.Builder? = null
     ...
     * the indication.
     */
    public var therapeuticIndication: MutableList<Reference.Builder> = mutableListOf()
    ...
    override fun build(): MedicinalProductContraindication =
